...
function git_prompt_info() {
  ...
  echo "${ZSH_THEME_GIT_PROMPT_PREFIX}${ref}${upstream}$(git_prompt_behind)$(git_prompt_ahead)$(git_prompt_stash)$(parse_git_dirty)${ZSH_THEME_GIT_PROMPT_SUFFIX}"
}
...
# Outputs if current branch has stashed files
